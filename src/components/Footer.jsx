...
export default function Footer() {
  return (
    <footer className="bg-gray-900 mt-10">
      <div className="mx-auto max-w-8xl px-10 pt-20 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm/6 font-semibold text-white">Free Tools</h3>
          ...
          <div className="mt-10 xl:mt-0">
            <h3 className="text-sm/6 font-semibold text-white">Get the App</h3>
           
            <img src={app} className="h-12 mb-5 mt-5"  />

            <img src={google} className="h-12" />

            <p className="mt-4 text-[22px] text-[#E5E4E4]">
             Join Our Newsletter.
            </p>
            <form className="mt-1 sm:flex sm:max-w-md">
              ...
              <input
                ...
                autoComplete="email"
                className="w-full min-w-0 rounded-md bg-white px-3 py-4 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:w-64 sm:text-sm/6 xl:w-full"
              />
              <div className="mt-4 sm:mt-0 sm:ml-4 sm:shrink-0">
                <button
                  type="submit"
                  className="flex w-full items-center justify-center rounded-md bg-[#0076CA] px-3 py-4 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                >
                  Subscribe
                </button>
              </div>
